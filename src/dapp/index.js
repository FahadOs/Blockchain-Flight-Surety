    ...
    let contract = new Contract('localhost', () => {
        ...
        DOM.elid('purchase').addEventListener('click', () => {
            ...
            if (insurance > 0) {
                contract.buy(passenger, insurance, flight, (error, result) => {
                    DOM.setMessage(DOM.elid('successMassage'),"Passenger purchased insurance successflly!");

                });
            } else {
                DOM.setMessage(DOM.elid('errorMassage'),"Passenger should buy insurance.");
        ...
        DOM.elid('register-airline').addEventListener('click', () => {
            ...
            contract.registerAirline(airline,(error, result) => {
                ...
                //DOM.appendText(DOM.elid('successMassage'),"");
                if (error == undefined || error == null  || error.toString().indexOf('invalid address') == -1)
                {
                    DOM.setMessage(DOM.elid('successMassage'),"Airline was successfully registered!");
                    DOM.elid('airline-address').value = "";
                    displayListAirline(airline, DOM.elid("airlines"));

                }
                else{
                    DOM.setMessage(DOM.elid('errorMassage'),error);
        ...
        DOM.elid('fund-airline').addEventListener('click', () => {
            ...
            contract.sendFundToAirline(airline, fund, (error, result) => {
                DOM.setMessage(DOM.elid('successMassage'),"Airline was successfully funded.");
        ...
        DOM.elid('withdraw').addEventListener('click', () => {
            ...
            contract.pay(passenger, (error, result) => {
                DOM.setMessage(DOM.elid('successMassage'),"successfully executed.");
        ...
        DOM.elid('claim').addEventListener('click', () => {
            let passenger = DOM.elid('passenger-address2').value;
            contract.payClaim(passenger, (error, result) => {
                DOM.setMessage(DOM.elid('successMassage'),"successfully executed.");
        ...
        DOM.elid('show').addEventListener('click', () => {
            ...
            contract.show(passenger, (error, result) => {
                DOM.setMessage(DOM.elid('successMassage'),"Show was successful");
